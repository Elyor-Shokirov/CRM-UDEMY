...
function Register({ onNavigateStateComponent }: LoginProps) {
	const { showPassword, toggleShow, showConfirmPassword, toggleShowConfirm } =
		useShowPassword()
						...
						<div className='flex gap-2'>
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										<FormLabel className='text-sm font-semibold dark:text-white text-gray-700 flex items-center gap-1'>
											<span>{t('register_input_confirm_password_label')}</span>
											<span className='text-red-500'>*</span>
										</FormLabel>
										<FormControl>
											<div className='relative'>
